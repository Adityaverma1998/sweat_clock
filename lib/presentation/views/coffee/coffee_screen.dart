      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            _buildCoffeeTier(
              context: context,
              title: context.translate('small_coffee'),
              price: '\$0.99',
              description: context.translate('fuel_desc'),
              icon: '☕',
              isBest: false,
            ),
            ...
            _buildCoffeeTier(
              context: context,
              title: context.translate('coffee_donut'),
              price: '\$1.99',
              description: context.translate('fuel_more_desc'),
              icon: '🍩',
              isBest: true,
            ),
            const SizedBox(height: 16),
